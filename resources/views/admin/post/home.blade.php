            ...
            <div class="box">
             <div class="box-header">
               ...
               <div class="box-body pad">
                <textarea name="body" style="width: 100%; height: 700px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" id="editor1">Body</textarea>
              </div>
             </div>

             <div class="box-footer">
              <input type="submit" class="btn btn-primary">
              <a href='{{ route('post.index') }}' class="btn btn-warning">Show post</a>
            </div>
          </form>
            </div>
